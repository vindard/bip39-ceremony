...
pub use domain::{
    ...
    protocol::{
        ...
        bitbox_word_index, bitpack_progress, coin_four_d6_progress, coin_four_d6_word_index,
        face_bits, jade_expected_die, jade_progress, jade_required_observations, jade_word_index,
        trace_word_exact,
    },
};

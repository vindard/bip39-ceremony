...
`6`; SeedSigner coin capture accepts `0` for tails and `1` for heads. Backspace
removes only the latest observation, while the next position and remaining count
